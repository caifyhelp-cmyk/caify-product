    ...
    return '''
      (function() {
        ...
        s.textContent = '(function(){'
          ...
          // 제목 <p> 요소 탐색 — SE3 모듈 내부 단락
          + 'var titleP=document.querySelector(".se-title-text .se-text-paragraph")'
          + '||document.querySelector(".se-title-text p")'
          + '||document.querySelector(".se-section-documentTitle p");'
          + 'if(!titleP){document.__caifyResult="no_title_p";return;}'
          // 에디터 contenteditable 루트 — <p>를 포함하는 CE
          ...
          + 'if(!seEd){document.__caifyResult="no_editor";return;}'
          // 에디터 포커스 후 제목 <p>에 selection 설정
          + 'seEd.focus();'
          + 'var sel=window.getSelection(),r=document.createRange();'
          + 'r.selectNodeContents(titleP);'
          + 'sel.removeAllRanges();sel.addRange(r);'
          // beforeinput → DOM 변경 → input 순서로 SE3 모델 갱신
          ...
          // 커서 해제 — 이후 본문 paste가 제목에 들어가는 것 방지
          + 'sel.removeAllRanges();seEd.blur();'
      ...
      (function() {
        ...
        if (iDoc2) {
          ...
          s2.textContent = '(function(){'
            ...
            // 본문 <p> 탐색 — 제목 영역 제외
            + 'var bodyP=document.querySelector(".se-component.se-text .se-text-paragraph")'
            + '||document.querySelector(".se-section-text p");'
            ...
            + 'if(!seEd2){document.__caifyResult2="no_editor2";return;}'
            + 'seEd2.focus();'
            + 'var sel2=window.getSelection(),r2=document.createRange();'
            + 'r2.selectNodeContents(bodyP);'
            + 'sel2.removeAllRanges();sel2.addRange(r2);'
            // paste ClipboardEvent — 이미지 네이버 라이브러리 업로드 유도
            + 'try{'
            ...
            + '}catch(pe){}'
            // paste 실패 시 beforeinput→innerHTML→input
            ...
            + 'seEd2.dispatchEvent(new Event("input",{bubbles:true}));'
