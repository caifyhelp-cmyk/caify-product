...
class _OutputsTabState extends State<OutputsTab>
                        ...
                        Container(
                          ...
                          child: const Row(
                            ...
                            children: [
                              ...
                              SizedBox(width: 3),
                              Text('발행완료', style: TextStyle(fontSize: 11, color: _green)),
                            ],
                          ),
                        ),
                    ],
                  ...
                  if (!published) ...[
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton.icon(
                        ...
                        label: const Text('발행하기', style: TextStyle(fontWeight: FontWeight.w600)),
  ...
  Future<void> _openPost(Map<String, dynamic> item) async {
    // Post 모델로 변환해서 PublishScreen으로 이동
            ...
            Row(
              children: [
                ...
                if (filesCount > 0) ...[
                  ...
                  const Icon(Icons.photo_library_outlined, size: 12, color: Colors.grey),
                  const SizedBox(width: 3),
                  Text('$filesCount장', style: const TextStyle(fontSize: 11, color: Colors.grey)),
                ],
              ],
            ),
          ],
